...
c1.cd()
multigraph.Draw("A")
multigraph.GetXaxis().SetRangeUser(ranges[0],ranges[1])
multigraph.Draw("A")
c1.Update()
Tline.Draw()
Tarrow.Draw()

leg.AddEntry(Tline,'m_{tW} selection','l')
leg.Draw()
...
c1.Print('plots_test/Trigger_'+tname+disc_string+'_'+name+'_Binomial.root', 'root')
c1.Print('plots_test/Trigger_'+tname+disc_string+'_'+name+'_Binomial.pdf', 'pdf')
